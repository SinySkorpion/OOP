...
class Терминал:
    ...
    def __init__(self):
        ...
        self.меню: список доступных принадлежностей;
        self.заказ: список заказанных принадлежностей;
        self.отображать_меню: определяет отображение меню
                              равен True: при создании терминала,
                              после отмены или подтверждения заказа.
        """
        # Доступные пиццы
        self.меню = [Карандаш(), Ручка(), ГелеваяРучка()]
        self.заказ = None
    ...
    def __str__(self):
        ...
        Имя канцелярия, версия программы.
        """
    ...
    def показать_меню(self):
        ...
        Принадлежность: Карандаш | Цена: 50.00 р.
        ...
        print(
            ...
            *[f'{i + 1}. ' + str(accessories) for i, accessories in enumerate(self.меню)],
            'Для выбора укажите цифру через <ENTER>.',
            'Для отмены заказа введите -1',
            'Для подтверждения заказа введите 0',
            sep='\n'
    ...
    def обработать_команду(self, пункт_меню):
        ...
        Возможные значения "пункт_меню":
          ...
          - 1..len(self.меню): добавление принадлежностей к добавить_к_заказу;
        ...
        try:
            ...
            if пункт_меню == Терминал.КОМАНДА_ОТМЕНА_ЗАКАЗА:
                ...
                print(f'Принадлежность {self.заказ.заказанные_принадлежности[-1].название} добавлена!')
